...
//				enterShot( 0, this.x+28, this.y,   vx2, vy2, pow );	//右
//				enterShot( 0, this.x+31, this.y+7, vx2, vy2, pow );
				if( this.power > 0 ){
					enterShot( 7, this.x+ 4, this.y+4, -1/spd, vy1, pow );
					enterShot( 7, this.x+28, this.y+4, 1/spd, vy1, pow );
				}
			}
